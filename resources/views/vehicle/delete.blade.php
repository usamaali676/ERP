...
@section('content')
    ...
    <div class="content content--top-nav">
        ...
        <div class="text-right mt-5">
            ...
            <a href="{{route('vehicle.conf-delete', $vehicle->id)}}" onclick="return confirm('Are you sure you want to delete this item')"  type="submit" class="btn btn-primary w-24">Delete</a>
        </div>
        <!-- END: Content -->
    @endsection
